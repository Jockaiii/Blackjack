...
namespace Blackjack
{
    internal static class InputHandler
    {
        ...
        internal static int PlayerAmountHandler()
        {
        ...
        internal static int DeckAmountHandler()
        {
            var amountOfDecks = Console.ReadLine();
            int.TryParse(amountOfDecks, out int result);
            if (result > 0)
                return result;
            return 0;
        }
        ...
        internal static int BetHandler(int currentPlayer)
        {
            var bet = Console.ReadLine();
            int.TryParse(bet, out int result);
